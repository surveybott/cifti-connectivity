...
p.addParameter('dataSuffix','*_den-91k_bold.dtseries.nii'); % '*_desc-smoothAROMAnonaggr_bold.dtseries.nii');
...
p.addParameter('tasks', {'movieDM','movieTP'});
...
p.addParameter('includeSub',{}); % list of subjects to include
...
cifti = bids2struct(dir(fullfile(inputs.dataDir,'sub-*','**',inputs.dataSuffix)));
